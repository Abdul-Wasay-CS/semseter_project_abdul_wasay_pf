...
public class Test {
    ...
    do {
      try {
        System.out.print("""
              ...
              ┃      What do you want to do?                           ┃
              ┃                                                        ┃
              ┃      1) View the logs        2) Create an account      ┃
              ┃                                                        ┃
              ┃      3) Delete an account    4) Block an account       ┃
              ┃                                                        ┃
              ┃      5) View Customer Accounts                         ┃
              ┃                                                        ┃
              ┃      6) Deposit Amount       7) Exit                   ┃
              ┃                                                        ┃
              ══════════════════════════════════════════════════════════
            Enter your choice:
                """);
  ...
  public static void createAccount() {
    ...
    // New Arraylist refernences to the arraylist Presesent in accountCredentials at
    // indexNumber
  ...
  public static void recoverAccount(int accountID) {
    ...
    for (int i = 3; i > 0; i--) {
      ...
      if (!answer.equalsIgnoreCase(securityQuestion.get(indexToRecover))) {
        ...
        viewAccountDetails(indexToRecover);
        out.println("Passkeys: " + accountCredentials.get(indexToRecover).get(PININDEX));
        return;
      }
    }
  ...
  public static void saveLogs() {
    try (FileOutputStream fos = new FileOutputStream("logs.txt", false); PrintWriter writer = new PrintWriter(fos)) {
    ...
    for (int i = 0; i < accountCredentials.size(); i++) {
      ...
      System.out.printf(
          """
              ...
              """,
          accountNames.get(i), accountCredentials.get(i).get(IDINDEX), accountCredentials.get(i).get(PININDEX),
          accountCredentials.get(i).get(BALANCEINDEX), accountCredentials.get(i).get(TRANSFERINDEX), blocked.get(i),
          accountExists.get(i));
    }
    System.out.println(
        "┗━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━┛");
